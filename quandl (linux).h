...
inline void quandl::get(std::string code){
	using namespace std;
...
inline void quandl::get(std::string code, std::string order, std::string StartDate, std::string EndDate,
	std::string transformation, std::string collapse, std::string rows, std::string type){
	using namespace std;
...
inline void quandl::download(std::string website, std::string FileName, std::string FileType){
	using namespace std;
